...
public class BookCatalogConsumerPactTest {
    ...
    @Pact(consumer = "library-client", provider = "book-catalog")
        ...
        return pactBuilder.given("books exist")
                ...
                .body(PactDslJsonArray
                        .arrayEachLike(3)
                            ...
                            .stringType("title", "Book1")
                            .stringType("authors", "Author1;Author2")
                       )
                .toPact();
    }
    ...
    void getAllBooks_whenBookExists(MockServer mockServer){
        List<Book> expectedBooks = List.of(new Book("101201", "Book1", "Author1;Author2"),
                new Book("101201", "Book1", "Author1;Author2"),
                new Book("101201", "Book1", "Author1;Author2"));
    ...
    void getBookByIsbn_whenBookExists(MockServer mockServer){
        Book expectedBook = new Book("101201", "Book1", "Author1;Author2");
